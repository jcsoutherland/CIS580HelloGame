...
namespace HelloGame
{
    public class HelloGame : Game
    {
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            if(ballPosition.X < GraphicsDevice.Viewport.X || ballPosition.X > GraphicsDevice.Viewport.Width - ballTexture.Width)
            {
                ballVelocity.X *= -1;
            }

            if (ballPosition.Y < GraphicsDevice.Viewport.Y || ballPosition.Y > GraphicsDevice.Viewport.Height - ballTexture.Height)
            {
                ballVelocity.Y *= -1;
            }
